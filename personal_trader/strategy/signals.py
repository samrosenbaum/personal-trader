...
class SignalGenerator:
    ...
    def generate(
        ...
        Args:
            ...
            microstructure: order book metrics
            volume_profile: volume profile with POC and value area
            anchored_vwap: anchored VWAP value
            vol_surface: options IV surface
            futures_basis: perpetual vs index basis
            portfolio_value: total portfolio USD value for position sizing
        """
        signals = []
        ...
        reasons = self._build_reasons(
            ...
            microstructure=microstructure, volume_profile=volume_profile,
            anchored_vwap=anchored_vwap, vol_surface=vol_surface,
